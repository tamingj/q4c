...
public interface UniSelect<Element1> {
    ...
    <Element2, Key> BiSelect<Element1, Element2> rightOuterJoin(Class<Element2> element2Type, Function<Element1, Key> element1KeyFunc, Function<Element2, Key> element2KeyFunc);

    <Element2, Key> BiSelect<Element1, Element2> fullOuterJoin(Class<Element2> element2Type, Function<Element1, Key> element1KeyFunc, Function<Element2, Key> element2KeyFunc);
